...
describe("QP2: Leaf Filters (MComparison, SComparison)", () => {
    ...
    const qp2 = new QP2(mockQueryValidator);
    ...
    it("GT Avg 95", async () => {
        ...
        const results: any[] = await qp2.performQuery(query, datasets, datasetIds);
...
describe("QP2: LogicComparisons (AND, OR, NOT)", () => {
    ...
    it ("NOT AVG GT 95", async () => {
        ...
        const results: any[] = await qp2.performQuery(not, datasets, datasetIds);
        /**
    ...
    it("AND1 [AVG GT 95]", async () => {
        ...
        const results: any[] = await qp2.performQuery(and1, datasets, datasetIds);
        /**
    ...
    it("AND2 [GT Avg 95, IS Dept *]", async () => {
        ...
        const results: any[] = await qp2.performQuery(and2, datasets, datasetIds);
        /**
         * Expected results: [6,7,8,9]
         */
    ...
    it("AND3 [GT Avg 95, IS Dept *, LT Avg 95]", async () => {
        ...
        const results: any[] = await qp2.performQuery(and3, datasets, datasetIds);
        /**
         * Expected results: []
         */
    ...
    it("OR3 [GT Avg 95, IS Dept *, LT Avg 95]", async () => {
        ...
        const results: any[] = await qp2.performQuery(or3, datasets, datasetIds);
        /**
    ...
    it("OR2 [GT Avg 95, LT Avg 95]", async () => {
        ...
        const results: any[] = await qp2.performQuery(or2, datasets, datasetIds);
        /**
    ...
    it("OR1 [GT Avg 95]", async () => {
        ...
        const results: any[] = await qp2.performQuery(or1, datasets, datasetIds);
        /**
...
describe("QP2: Order", () => {
    ...
    it ("Order by Avg", async () => {
        ...
        const results = await qp2.performQuery(query, datasets, datasetIds);
